...
public class MyProgressCircle extends View {
    ...
    int circle_diameter=sp2px(30);//圆的直径大小
...
//widthMode != MeasureSpec.EXACTLY ||
    ...
    public void intDATA(Context context, AttributeSet attrs) {
        ...
        line_background_color = typedArray.getColor(R.styleable.CircleProgress_CircleProgress_line_background_color, Color.BLACK);
        line_font_progress = typedArray.getColor(R.styleable.CircleProgress_CircleProgress_line_font_progress, Color.RED);
        line_weight = (int) typedArray.getDimension(R.styleable.CircleProgress_CircleProgress_line_weight, line_weight);
        circle_diameter= (int) typedArray.getDimension(R.styleable.CircleProgress_CircleProgress_circle_diameter,circle_diameter);
        text_color = typedArray.getColor(R.styleable.CircleProgress_CircleProgress_text_color, Color.GREEN);
        mTextSize = (int) typedArray.getDimension(R.styleable.CircleProgress_CircleProgress_text_size, mTextSize);
        //currentProgress=30;
    }
