 ...
 */
public class autolayout_button extends ViewGroup {

    List Row_Height = new ArrayList();

    public autolayout_button(Context context) {
        super(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public autolayout_button(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public autolayout_button(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public autolayout_button(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
