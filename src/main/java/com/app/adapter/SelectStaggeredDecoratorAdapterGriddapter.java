 ...
 */
public class SelectStaggeredDecoratorAdapterGriddapter extends RecyclerView.Adapter<SelectStaggeredDecoratorAdapterGriddapter.MyViewHolder> {
    ...
    public SelectStaggeredDecoratorAdapterGriddapter(Context context, List<String> mDatas) {
        super();
