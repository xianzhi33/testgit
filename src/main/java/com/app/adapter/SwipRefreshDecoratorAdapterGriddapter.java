 ...
 */
public class SwipRefreshDecoratorAdapterGriddapter extends RecyclerView.Adapter<SwipRefreshDecoratorAdapterGriddapter.MyViewHolder> {
    ...
    public SwipRefreshDecoratorAdapterGriddapter(Context context, List<String> mDatas) {
        super();
